# https://github.com/MrShadowDev/Free-Canva-Pro-Lifetime
...
async def main():
    ...
    print("Trying to find canva pro for you! Please wait 120s...")
    await page.waitForXPath("//*[@id='download']", {'visible': True, 'timeout': 120000})
    ...
    if button:
        ...
        if href_link:
            ...
            print("Could not find the link to Canva Pro.")
    else:
        print("Could not find the button to download Canva Pro.")
